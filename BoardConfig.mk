...
# Audio
# Got the info for these from 
# https://github.com/StormBreakerOSS/platform_hardware_qcom-caf_sm8250_audio/blob/reikon/configs/bengal/bengal.mk
...
# Display
# Found these in default config of 
# https://github.com/StormBreakerOSS/platform_hardware_qcom-caf_sm8250_display
...
# DRM
# Found some text around drm in devices in stock init files
...
# HIDL
# TODO Stopper: need to validate and see if we are copying some from proprietary files
...
# Media
# No info on this found through search. Saw this enabled on hammerhead and
# shamu old devices so leaving it as is
...
# TODO Stopper: Generate files and fix this
